...
## III. This H2 heading is NOT the only one.
...
## V. This H2 heading is for the remaining tests
...
≤fboulangerie≥ ---> any one of these: <i class="foreign">boulangerie</i> or "word-as-word", "synonym" (depending on context)
